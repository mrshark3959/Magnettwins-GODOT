...
@export var tip_text: String = "Fun Fact: The strongest magnetic field ever created in a lab was about 1200 Tesla 
(millions of times stronger than Earth's magnetic field)"
